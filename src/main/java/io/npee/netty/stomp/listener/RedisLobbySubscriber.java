...
public class RedisLobbySubscriber implements MessageListener {
    ...
    public void onMessage(Message message, byte[] pattern) {
        ...
        try {
            ...
            simpMessageSendingOperations.convertAndSend("/topic/lobby", chatMessage);
